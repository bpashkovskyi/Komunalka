...
const hostURL = "";
const criteriaArray = [];
criteriaArray["cities"] = "Місто";
criteriaArray["years"] = "Рік";
criteriaArray["types"] = "Вид пригоди";
criteriaArray["reasons"] = "Основна причина ДТП";
criteriaArray["surfaceTypes"] = "Тип покриття";
criteriaArray["surfaceConditions"] = "Стан покриття";
criteriaArray["lightings"] = "Освітленість";
criteriaArray["roadElements"] = "Елементи ділянки";
criteriaArray["constructions"] = "Штучні споруди";
criteriaArray["weatherConditions"] = "Погодні умови";
criteriaArray["trafficTools"] = "Технічні засоби організації дорожнього руху";
criteriaArray["isPlaceOfAccidentConcentration"] = "Є місцем концентрації ДТП";
