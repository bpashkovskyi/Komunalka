...
namespace Komunalka.Persistence.Migrations
{
    ...
    [Migration("20250525125403_AddNormalizedFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accidents.Model.Accident", b =>
                {
                    ...
                    b.ToTable("Accidents", "komunalka");
                });

            modelBuilder.Entity("Advertising.Model.Board", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DistributorIdentifier")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DistributorName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("HorizontalSizeValue")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("VerticalSizeValue")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.ToTable("Boards", "komunalka");
                });

            modelBuilder.Entity("Light.Model.Point", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Accidents.Model.Address", "Address", b1 =>
                        {
                            ...
                            b1.ToTable("Accidents", "komunalka");
            ...
            modelBuilder.Entity("Advertising.Model.Board", b =>
                {
                    b.OwnsOne("Advertising.Model.Address", "Address", b1 =>
                        {
                            b1.Property<int>("BoardId")
                                .HasColumnType("int");

                            b1.Property<string>("AdminUnitL1")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("AdminUnitL2")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("AdminUnitL3")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("Description")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("LocatorBuilding")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("LocatorDesignator")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.Property<string>("Thoroughfare")
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("BoardId");

                            b1.ToTable("Boards", "komunalka");

                            b1.WithOwner()
                                .HasForeignKey("BoardId");
                        });

                    b.OwnsOne("Advertising.Model.Coordinates", "Coordinates", b1 =>
                        {
                            b1.Property<int>("BoardId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Light.Model.Point", b =>
                {
                    b.OwnsOne("Light.Model.Address", "Address", b1 =>
                        {
                            ...
                            b1.ToTable("Points", "komunalka");

                            b1.WithOwner()
                                .HasForeignKey("PointId");
                        });

                    b.OwnsOne("Light.Model.Coordinates", "Coordinates", b1 =>
                        {
                            b1.Property<Guid>("PointId")
                                .HasColumnType("uniqueidentifier");
